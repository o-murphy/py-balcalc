...
class ProfileTab(QWidget, Ui_profilesTab):
    def __init__(self, payload: a7p.Payload):
        super().__init__()

        self._payload = payload

        self._profile = ProfileItem(self)
        self._profile.set(self._payload)
        ...
        #         pass
        #
        self.profile_current.set_current(self._profile)

        self.setupConnects()

    def setupUi(self, profiles_tab: 'ProfileTab'):
        """Sets default widget positions in a gridLayout"""
        super(ProfileTab, self).setupUi(profiles_tab)
        ...
        self.gridLayout.addWidget(self.profile_current, 0, 0, 0, 0)
    ...
    #         new_item.set(data)
    #         self.add_table_item(new_item)

    # def add_table_item(self, new_item):
    ...
    #     index = self.profiles_table.currentIndex()
    #     print(self.profiles_table.cellWidget(index.row(), index.column()).get())
    #
